...
$.extend( Scroller.prototype, {
	...
	*/
	 ...
	 *  @param {int} [virtual=false] Perform the calculations in the virtual entities
	...
	/**
	 * Convert from one entities to another. The physical entities is the actual
	 ...
	 * only to that maximum value and virtual / physical entities transforms will
